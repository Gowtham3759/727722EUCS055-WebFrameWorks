...
import com.example.day5cw2.service.GowthamEmployeeService;
...
public class GowthamEmployeeController {
    ...
    public ResponseEntity<GowthamEmployee> putMethodName(@PathVariable("employeeId") int id, @RequestBody GowthamEmployee employee) {
    ...
    public ResponseEntity<GowthamEmployee> delete(@PathVariable("employeeId") int id,@RequestBody GowthamEmployee employee)
    {
